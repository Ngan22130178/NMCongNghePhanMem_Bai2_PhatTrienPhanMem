...
### 1. Nhóm Use Case 5 & 6: Xử lý hình phạt & Kết thúc lượt (Penalty & Session End)
...
| **Tiền điều kiện** | Người chơi đang trong chế độ tương tác (Prank Mode) và thanh chỉ số Suspicion đã được khởi tạo.
 ...
 |
| **Luồng sự kiện chính** | 1. Hệ thống liên tục cập nhật chỉ số Suspicion dựa trên hành động của người chơi.2. Khi Suspicion đạt ngưỡng 100%, hệ thống kích hoạt hoạt cảnh (animation) phản ứng từ thú cưng.3. Hệ thống hiển thị thông báo "Phản ứng đáp trả" (Penalty) mang tính hài hước.4. Hệ thống thực hiện UC6: Tự động dừng phiên chơi (End Game).5. Hệ thống hiển thị bảng kết quả và yêu cầu người chơi bắt đầu lượt mới.
